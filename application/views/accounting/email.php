                            ...
                            <tr mc:hideable>
								<td align="center" valign="top">
									...
									<table border="0" cellpadding="0" cellspacing="0" width="100%">
										<tr>
											<td>
												<div style="text-align:right;padding:0 20px"><?php echo date('F d, Y') ?></div>
											</td>
										</tr>
										<tr>
											<td style="padding:0 20px"><br>
												<?php echo $consumer->account_number ?><br>
												<?php echo $consumer->firstname . ' ' . $consumer->lastname ?><br>
												<?php echo $consumer->address ?><br>
											</td>
										</tr>
										<tr>
											<td align="center" valign="top"><br>
													<h2><center style="font-family:Courier New">NOTICE OF DISCONNECTION</center></h2>
													<br>
